...
class CfgVehicles
{
	...
	class Hatt_ILCS: MA_M56S_Rucksack_ODST_Radio
	{
		scopeArsenal=2;
		author="6th STB S-5";
		displayName="[6th] Hatt Rucksack";
		hiddenSelections[]= 
		{
			"camo1",
			"camo2",
		...
		hiddenSelectionsTextures[]=
		{
		"Backpacks\Textures\Hatt_ILCS.paa"
		};
	    maximumLoad=300;
	    tf_hasLRradio=1;
	    tf_encryptionCode="tf_west_radio_code";
	...
	class Viper_ILCS:MA_M56S_Rucksack
	{
		scopeArsenal=2
		author="6th STB S5";
		displayname="[6th] Viper Rucksack";
	   hiddenSelections[]= 
	   {
		"camo1",
        "camo2",
	   ...
	   hiddenSelectionsTextures[]=
	   {
		"Backpacks\Textures\Viper_ILCS.paa"  
	   };
	   maximumLoad=300
	};
	class Viper_Corpsman_ILCS:MA_M56S_Rucksack
	{
		scopeArsenal=2
		author="6th STB S5";
		displayname="[6th] Viper Corpsman Rucksack";
	   hiddenSelections[]= 
	   {
		"camo1",
        "camo2",
	   ...
	   hiddenSelectionsTextures[]=
	   {
		"Backpacks\Textures\Viper_Corpsman_ILCS.paa"  
	   };
	   maximumLoad=300
	};
};